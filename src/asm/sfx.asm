...
; SFX buffer ids:
BUF_ACHTUNG: equ 0x2000
BUF_ACHTUNG2: equ 0x2001
BUF_AHH: equ 0x2002
BUF_AUF_WEIDERSHEN: equ 0x2003
BUF_AUGH: equ 0x2004
BUF_AYEE: equ 0x2005
BUF_AYEE_HIGH: equ 0x2006
BUF_BANG2: equ 0x2007
BUF_DOG_WOOF: equ 0x2008
BUF_DOG_YELP: equ 0x2009
BUF_DOOR_SHUT: equ 0x200A
BUF_ENEMY_GATLING: equ 0x200B
BUF_EVA: equ 0x200C
BUF_GIB: equ 0x200D
BUF_GOT_TREASURE: equ 0x200E
BUF_GUARD_SHOT_PISTOL: equ 0x200F
BUF_GUTEN_TAG: equ 0x2010
BUF_LOCKED_DOOR: equ 0x2011
BUF_MEIN_LEBEN: equ 0x2012
BUF_MUTTI: equ 0x2013
BUF_SCHUSSTAFFEL: equ 0x2014
BUF_SHOT_MACHINE_GUN: equ 0x2015
BUF_SHOT_MACHINE_GUN_SINGLE: equ 0x2016
BUF_SHOT_PISTOL: equ 0x2017
BUF_SPION: equ 0x2018
BUF_UGH: equ 0x2019
BUF_WILHELM: equ 0x201A
BUF_WOOF: equ 0x201B
