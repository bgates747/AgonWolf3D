...
def make_uvs(db_path, mapmaker_tiles_dir, uvs_tgt_dir, src_tiles_path, thumbs_tgt_dir):
...
if __name__ == "__main__":
    ...
    make_uvs(db_path, mapmaker_tiles_dir, uvs_tgt_dir, src_tiles_path, thumbs_tgt_dir)
