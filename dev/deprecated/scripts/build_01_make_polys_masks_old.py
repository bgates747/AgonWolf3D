...
def update_poly_bbox(db_path):
    ...
    cursor.execute('''
        ...
        set 
            ...
            dim_x = case when poly_x1 - poly_x0 > poly_x2 - poly_x3 then
                poly_x1 - poly_x0 else poly_x2 - poly_x3 end,
            dim_y = case when poly_y2 - poly_y0 > poly_y3 - poly_y1 then
                poly_y2 - poly_y0 else poly_y3 - poly_y1 end;
    ''')
    conn.commit()
    conn.close()
...
def make_polys_masks(db_path, masks_directory, min_scanlines, img_size):
...
if __name__ ==  "__main__":
    ...
    make_polys_masks(db_path, masks_directory, min_scanlines, img_size)