...
def main():
    ...
    with open(OUTPUT_FILENAME, 'w') as asm_writer, open(buffer_id_lookup_file, 'w') as lookup_writer:
        ...
        for _, row in df.iterrows():
            base_filename = row['base_filename']
            asm_writer.write(f"F{base_filename}: db \"../src/rgb2/{base_filename}.rgba\",0\n")
...
if __name__ == "__main__":
    ...
    OUTPUT_FILENAME = "src/asm/images2.inc"
    tgt_panels_rgb2_dir = "tgt/assets/images/panels/"
    buffer_id_lookup_file = "src/asm/buffer_id_lookup_table.inc"
