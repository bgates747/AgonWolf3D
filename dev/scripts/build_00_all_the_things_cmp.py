...
def do_all_the_things(db_path, map_dim_x, map_dim_y, screen_size, view_distance, screen_width, screen_height, tgt_dir):
    ...
    uvs_tgt_cmp_dir = 'build/panels/uv'
    thumbs_tgt_cmp_dir = 'build/panels/thumbs'
    if do_02_fetch_tiles:
        from build_02_fetch_tiles import fetch_tiles
        fetch_tiles(db_path, src_tiles_path, mapmaker_tiles_dir, uvs_tgt_cmp_dir, thumbs_tgt_cmp_dir)

    # build_04_make_panels_png_cmp.py
    panels_png_dir = 'build/panels/png'
    thumbs_dir = 'build/panels/thumbs'
    if do_04_make_panels_png:
        from build_04_make_panels_png_cmp import make_panels_and_sprites
...
# build_05_make_panels_rgba.py
    ...
    if do_05_panels_rgba:
        from build_05_make_panels_rgba_cmp import make_panels_rgba
...
# build_91_asm_panels.py
    if do_91_asm_panels:
        from build_91_asm_panels_cmp import make_asm_panels, make_asm_sprites, make_asm_dws
...
# build_91a_asm_font.py
    if do_91a_asm_font:
        from build_91a_asm_font_cmp import maken_zee_fonts
        maken_zee_fonts()

# build_91b_asm_ui.py
    if do_91b_asm_ui:
        from build_91b_asm_ui_cmp import make_tbl_91b_UI, make_rgba2_files, make_asm_ui
        ui_inc_path = "src/asm/ui_img.inc"
        src_png_dir = "src/assets/images/ui"
        tgt_cmp_rgba2_dir = "tgt_cmp/ui"
        buffer_id = 0x2000
...
# build_92_asm_ez80Asmlinker.py
    if do_92_asm_ez80Asmlinker:
        ...
        full_tgt_cmp_base_dir = f"{project_base_dir}/tgt_cmp"
        full_panels_path = f"{project_base_dir}/src/asm/panels.inc"
        do_assembly(project_base_dir, full_db_path, full_tgt_cmp_base_dir, full_src_base_dir, floor_nums, room_ids, full_panels_path, view_distance, map_dim_x, map_dim_y)
...
# Set build parameters
    ...
    tgt_dir = 'tgt_cmp' # This is where all the build artifacts go
