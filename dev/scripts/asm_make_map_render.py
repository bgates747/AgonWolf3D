...
# Its code has been folded into build_92_asm_ez80Asmlinker.py
###############################################
...
def asm_make_map_render_routines(db_path, floor_num, room_id, panels_path):
    ...
    with open(map_tgt_path, 'w') as writer:
        ...
        query = """
        SELECT t1.cell_id, t1.map_x, t1.map_y, t1.tile_name, max(coalesce(t2.to_render_obj_id,t2.to_obj_id)) as to_obj_id
        ...
        WHERE t1.floor_num = ? AND t1.room_id = ? 
        ...
        for cell in render_cells:
            ...
            if to_obj_id is not None:
                ...
                for orientation in range(4):
                    ...
                    FROM (
                        SELECT poly_id, coalesce(to_render_obj_id,to_obj_id) as to_obj_id
...
# # THIS MEANT TO BE CALLED BY do_92_asm_ez80Asmlinker
# if __name__ == '__main__':
#     db_path = 'build/data/build.db'
#     panels_path = 'src/asm/panels.inc' 
#     floor_num = 0
#     room_id = 0
#     asm_make_map_render_routines(db_path, floor_num, room_id, panels_path)
