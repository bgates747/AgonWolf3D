...
def do_all_the_things(
    ...
    autogenerated_asm_path = "src/asm/autogenerated.asm"

    maps_by_floor = {}
    floor_nums = []
    if (
        do_06_import_mapmaker_files
        or do_07_map_panels
        or do_91c_asm_map_masks
    ):
        from build_06_map_import_mapmaker import discover_mapmaker_files
        maps_by_floor = discover_mapmaker_files(map_src_dir)
        floor_nums = list(maps_by_floor)
...
# build_07_polys_make_map_panels
    if do_07_map_panels:
        ...
        for floor_index, floor_num in enumerate(floor_nums):
...
# build_90_asm_polys.py
    if do_90_asm_polys:
        ...
        polys_inc_path = autogenerated_asm_path
    ...
    if do_91_asm_images:
        ...
        panels_inc_path = autogenerated_asm_path
...
# build_91a_asm_font.py
    if do_91a_asm_font:
        ...
        maken_zee_fonts(next_buffer_id, autogenerated_asm_path)
...
# build_91b_asm_ui.py
    if do_91b_asm_ui:
        ...
        ui_inc_path = autogenerated_asm_path
...
# build_91c_asm_map_masks.py
    if do_91c_asm_map_masks:
        ...
        update_maps_asm(db_path, autogenerated_asm_path)
...
# build_98_asm_sfx.py
    sfx_inc_path = autogenerated_asm_path
    sfx_tgt_dir = 'sfx'
    if do_98_asm_sfx:
