...
def do_all_the_polys(db_path, polys_inc_path):
    with generated_asm_section(polys_inc_path, "POLYS") as section_path:
        make_asm_polys_plot(db_path, section_path)
        make_asm_cube_poly_idx(db_path, section_path)
        make_asm_cube_img_idx(db_path, section_path)
        make_asm_polys_map_deltas(db_path, section_path)
        make_asm_polys_south(db_path, section_path)
        make_asm_plot_sprites(db_path, section_path)
        make_map_type_status(db_path, section_path)

if __name__ == "__main__":
    db_path = 'build/data/build.db'
    polys_inc_path = "src/asm/autogenerated.asm"
