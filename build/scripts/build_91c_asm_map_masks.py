...
import subprocess
import hashlib
from asm_sections import replace_asm_section
...
def update_maps_asm(db_path, asm_file_path="src/asm/autogenerated.asm"):
    ...
    asm_content = [f"start_obj_id: equ {start_obj_id}\n"]
