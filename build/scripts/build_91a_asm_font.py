...
def _write_asm_font(db_path,font_inc_path,buffer_id_counter,space_width,font_name,abbr_name):
...
def make_asm_font(db_path,font_inc_path,buffer_id_counter,space_width,font_name,abbr_name):
    with generated_asm_section(font_inc_path, "FONT") as section_path:
        _write_asm_font(
            db_path,
            section_path,
            buffer_id_counter,
...
def main(font_name, abbr_name, lines_of_text, line_starts, character_height, buffer_id_counter, space_width, scale_method, font_inc_path):
...
def maken_zee_fonts(next_buffer_id, font_inc_path="src/asm/autogenerated.asm"):
