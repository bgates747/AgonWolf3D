...
def do_assembly(project_base_dir, full_db_path, full_tgt_base_dir, full_src_base_dir, floor_nums, room_ids, full_panels_path):
    ...
    for floor_num in floor_nums:
        for room_id in room_ids:  # Assuming room_ids is now a list of integers
            asm_make_map_render_routines(project_base_dir, full_db_path, floor_num, room_id, full_panels_path)
